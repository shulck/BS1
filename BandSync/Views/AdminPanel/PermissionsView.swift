...
struct ModulePermissionEditorView: View {
        ...
        NavigationView {
            ZStack {
                Form {
                    ...
                    if permissionService.errorMessage != nil {
                        Section {
                            Text(permissionService.errorMessage ?? "Unknown error")
                                .foregroundColor(.red)
                        }
                    }
                }
    ...
    private func loadCurrentRoles() {
        ...
        isAdmin = AppState.shared.user?.role == .admin
    }
    ...
    private func savePermissions() {
        // Make sure we're not removing admin from the admin module
